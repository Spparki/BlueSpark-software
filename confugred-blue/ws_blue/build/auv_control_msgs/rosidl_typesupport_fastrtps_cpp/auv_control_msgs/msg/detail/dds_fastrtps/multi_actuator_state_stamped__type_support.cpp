...
#include "auv_control_msgs/msg/detail/multi_actuator_state_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.reference_names;
  }
  // Member: reference
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: reference_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.reference_names[index].size() + 1);
    }
  }
  // Member: reference
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.reference[0]);
  ...
  // Member: output_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.output_names[index].size() + 1);
    }
  }
  // Member: output
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auv_control_msgs::msg::MultiActuatorStateStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auv_control_msgs::msg::MultiActuatorStateStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_control_msgs::msg::MultiActuatorStateStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultiActuatorStateStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auv_control_msgs::msg::MultiActuatorStateStamped *>(
...
static size_t _MultiActuatorStateStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MultiActuatorStateStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MultiActuatorStateStamped__callbacks = {
...
static rosidl_message_type_support_t _MultiActuatorStateStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MultiActuatorStateStamped__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_auv_control_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<auv_control_msgs::msg::MultiActuatorStateStamped>()
{
  return &auv_control_msgs::msg::typesupport_fastrtps_cpp::_MultiActuatorStateStamped__handle;
}
