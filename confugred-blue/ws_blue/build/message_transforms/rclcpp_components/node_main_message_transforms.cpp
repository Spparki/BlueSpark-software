...
#define NODE_MAIN_LOGGER_NAME "message_transforms"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmessage_transforms_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<m2m::MessageTransforms>";
